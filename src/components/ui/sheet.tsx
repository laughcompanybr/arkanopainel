...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, children, description, "aria-describedby": ariaDescribedBy, ...props }, ref) => {
  const autoDescId = React.useId();
  const hasExplicitDesc = ariaDescribedBy !== undefined;
  const describedBy = hasExplicitDesc ? ariaDescribedBy : autoDescId;
  return (
    <SheetPortal>
      <SheetOverlay />
